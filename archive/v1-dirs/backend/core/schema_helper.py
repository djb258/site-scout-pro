...
1. Document a new table:
   from backend.core.schema_helper import document_table
...
2. Document a new column:
   from backend.core.schema_helper import document_column
...
3. Create a documented table (combines CREATE TABLE + documentation):
   from backend.core.schema_helper import create_documented_table
