...
| CC-04 Process | Build Cost Calculator implementation |
...
|------|------|-------------|
| CONST (Input) | Unit mix, site conditions | Consumed by Build Cost Calculator |
| VAR (Output) | Total build cost | Produced by Build Cost Calculator |
