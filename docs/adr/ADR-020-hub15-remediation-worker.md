...
| CC-04 Process | Hub 1.5 Remediation Worker implementation |
...
|------|------|-------------|
| CONST (Input) | Gap queue items | Consumed by Hub 1.5 Remediation Worker |
| VAR (Output) | Resolved rate data | Produced by Hub 1.5 Remediation Worker |
