...
| A.1.2 | Constants (inputs) are declared | [ ] | See PRD_PASS2_UNDERWRITING_HUB.md Section 5 |
| A.1.3 | Variables (outputs) are declared | [ ] | See PRD_PASS2_UNDERWRITING_HUB.md Section 6 |
| A.1.4 | CONST -> VAR transformation is defined | [ ] | See PRD_PASS2_UNDERWRITING_HUB.md Section 3 |
...
| # | Check | Status | Evidence |
|---|-------|--------|----------|
| A.2.1 | PRD exists and follows v2.0.0 template | [ ] | docs/prd/PRD_PASS2_UNDERWRITING_HUB.md |
...
| # | Check | Status | Evidence |
|---|-------|--------|----------|
| A.3.1 | ERD exists for this pass | [ ] | docs/erd/ERD_SubHub2_CountyCard.md |
