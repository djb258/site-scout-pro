...
import { ERD_REGISTRY, ERDEntry } from "@/config/erd-registry";
import { ERDDiagramCard } from "@/components/erd/ERDDiagramCard";
import { ERDDashboard, ERDSubHubSummary } from "@/components/erd/ERDDashboard";
