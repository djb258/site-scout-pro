...
import type { LocalCompetitor, CallSheetEntry, AiCallerPricing } from '../../shared/OpportunityObject';
import { writeData, writeLog, writeErrorLog, TABLES } from '../../shared/adapters/LovableAdapter';
